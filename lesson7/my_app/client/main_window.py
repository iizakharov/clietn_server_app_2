...
from config.errors import ServerError
...
class ClientMainWindow(QMainWindow):
    ...
    def set_disabled_input(self):
        ...
        self.ui.label_new_message.setText(
            'Для выбора получателя дважды кликните '
        ...
        if sender == self.current_chat:
            ...
            if self.database.check_contact(sender):
                ...
                if self.messages.question(
                    ...
                    # будет потеряно, т.к. на момент предыдущего
    ...
    # Слот сообщения 205 - требование сервером обновить справочники
    # доступных пользователей и контактов
    # Может получиться так, что удалён текущий собеседник, надо проверить
    # это и закрыть чат с предупреждением.
